...
public function getallchapitre(){
    ...
    public function addchapitre(Request $request)
    {
        $this->validate($request, [
            ...
            'image' => ['image','mimes:jpeg,png,jpg,tiff|max:2048'],
                ...
                $chapitre->image="http://localhost:8000/upload/chapitres/".$filename;
    ...
    public function update(Request $request, $id)
    {
            ...
            session()->flash('success','la mise à jour  de chapitre a été effectuée avec succès');
            return back()->withInput();
    ...
    public function showbook($id)
    {
       ...
       $pages=Page::where('chapitre_id',$id)->orderby('num_page')->paginate(9);
